                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('description')?? $item->description }}" name="description" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Food Descripton">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-500 text-xs italic">Dipisahkan dengan koma, Contoh: Bawang merah, Bawang putih, Paprika, Timun</p>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-500 text-xs italic">Dipisahkan dengan koma, Contoh: Recommended, Popular, New_Food</p>
                        </div>
                    </div>
